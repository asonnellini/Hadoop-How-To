...
This repository describes the steps I followed to practice with Hadoop during the Hadoop class at DSTI.
  ...
  - [How to create a table on HBase, insert a record and enable versioning](https://github.com/asonnellini/Hadoop-How-To/blob/master/Documents/Create-HBase-Table/How-to-create-table-HBase.md#how-to-create-a-table-on-hbase)
